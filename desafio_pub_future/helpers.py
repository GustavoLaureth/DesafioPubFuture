...
def calculate_interval_between_dates(start_date, end_date, days_or_months):
    if days_or_months == 'days':
        ...
        raise Exception('add interval_to_date accepts only str "days" or "months" for days_or_months')
...
def calculate_repetitive_total(obj, last_balance, today):
    ...
    if obj.repetition_interval == 2: # DAYS
        ...
        raise Exception('calculate_repetitive_total object repetition_interval can be between 2 to 5 incl.')
